...
class TestViews(SimpleTestCase):
    ...
    def test_DocView_GET(self, mock_get_doc_reqs, mock_get_repos_from_file, mock_repo_info):
        ...
        mock_get_doc_reqs.assert_called_once_with("repo_folder")
        self.assertEqual(response.status_code, status.HTTP_200_OK)
    ...
    def test_UnlinkView_GET(self, mock_serial, mock_get_reqs, mock_get_repos_from_file, mock_repo_info):
        ...
        mock_get_repos_from_file.assert_called_once()
        mock_repo_info.assert_called_once()
        mock_get_reqs.assert_called_once_with("repo_folder")
    ...
    @patch("MyServer.repoHelpers.getReposFromFile", return_value={"repo_name": "repo_url"})
    @patch("MyServer.restHandlersHelpers.getAllReqs")
    def test_UnlinkView_GET_noReqs(self, mock_get_reqs, mock_get_repos_from_file, mock_repo_info):
